...
my $ctrl_file='spc_list.indv';     # control file: spc_list
...
my $output_lbl_file;          # filename *_bondlength.lbl.indv.dat in which all species are labelled
...
my $file_spc_time;            # file name for species as a function of time
...
#$_='10036';
#$tgt_id=$_;
$file_spc_time="spc_time_distribution.indv$tgt_id.dat";
...
#foreach $tgt_id (@tgt_ids)
{
  ...
  $output_lbl_file="$tgt_id\_bondlength.lbl.indv.dat";
...
my $spc_nm;
open (SPC_LIFE,">spc_life.$tgt_id.dat");
## output header
